...
sendVarToJS('eqType', 'hcl');
$eqLogics = eqLogic::byType('hcl');

?>

<div class="row row-overflow">
  <div class="col-lg-2 col-sm-6 col-sm-4" id="hidCol" style="display: none;">
  ...
  <div class="col-lg-12 eqLogicThumbnailDisplay" id="listCol">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        echo '<img src="plugins/hcl/plugin_info/hcl_icon.png" height="105" width="95" />';
        echo "</center>";
          ...
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement deepface}}"/>
              </div>
            </div>
            <div class="form-group">
...
<?php include_file('desktop', 'hcl', 'js', 'hcl'); ?>
